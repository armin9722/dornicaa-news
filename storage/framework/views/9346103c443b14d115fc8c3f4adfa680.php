...
<?php endif; ?>
    ...
    <div class="flex flex-col gap-1">
        <?php $__queriesSlice = array_slice($queries, 0, 100); ?>
        <?php if(!empty($__queriesSlice)): ?>
            <?php $__currentLoopData = $__queriesSlice; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
...
<?php /**PATH C:\Users\D.H.ERAM\PhpstormProjects\dornica-news\vendor\laravel\framework\src\Illuminate\Foundation\Providers/../resources/exceptions/renderer/components/query.blade.php ENDPATH**/ ?>